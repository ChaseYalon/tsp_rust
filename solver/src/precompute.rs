...
impl SpatialGrid {
    pub fn new(points: &[Point]) -> Self {
        ...
        let mut grid =
            HashMap::with_capacity_and_hasher(points.len() * points.len(), Default::default());
    ...
    pub fn query_edge_candidates(
        ...
        let points_to_test = [
            ...
            edge_end,
            Point {
                x: (edge_end.x + edge_start.x) / 2.0,
                y: (edge_end.y + edge_start.y) / 2.0,
            },
        ];
